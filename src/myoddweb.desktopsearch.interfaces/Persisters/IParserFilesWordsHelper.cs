...
{
  public interface IParserFilesWordsHelper : IDisposable
  {
    /// <summary>
    ...
    /// <summary>
    /// Get a list of files that have that word id.
    /// </summary>
    /// <param name="wordId">The word id we are looking for</param>
    /// <param name="token"></param>
    /// <returns></returns>
    Task<IList<long>> GetFileIdsAsync(long wordId, CancellationToken token);
    ...
    /// <summary>
    /// Delete all the files that are linked to a single word id.
    /// </summary>
    /// <param name="wordId"></param>
    /// <param name="token"></param>
    /// <returns></returns>
